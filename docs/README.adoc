...
| {counter:srn}|sudo subscription-manager repos --enable=ansible-automation-platform-2.0-early-access-for-rhel-8-x86_64-rpms | Enable early access repository in bastion/control node.
